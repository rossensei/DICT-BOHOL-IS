...
<template>
    <div>
        ...
        <form @submit.prevent="submit" class="flex items-center space-x-2 ">
            <label for="new-category" class="relative w-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                ...
                id="new-category"
                type="text"
                class="w-full text-sm rounded-lg pl-9 py-2"
