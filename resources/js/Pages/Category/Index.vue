    ...
    <AppLayout>
        ...
        <div class="py-12">
            <div class="w-full px-12">
                <h1 class="text-2xl text-gray-700 font-bold mb-4">Categories</h1>
                        ...
                        <li v-for="category in categories.data" :key="category.id">
                            <div class="flex items-start space-x-3 hover:bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="shrink-0 divide-x divide-gray-600">
                                    ...
                                    <button type="button" @click="deleteCategory(category)" class="px-2 font-medium text-red-600">Delete</button>
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    <Modal :show="showModal" maxWidth="xl" @close="closeModal">
        <div class="p-6">
            ...
            <div class="flex justify-end space-x-2">
                <button type="button" @click="closeModal" class="px-4 py-2 bg-gray-500 hover:bg-gray-400 rounded-lg text-sm text-white font-medium">Cancel</button>
