                            ...
                            <tr v-for="emp in employees.data" :key="emp.id" class="bg-white hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <Link id="delete-button" :href="`/employees/delete/${emp.id}`" method="DELETE" data-tool-tip="Delete" class="w-8 h-8 flex justify-center items-center hover:bg-gray-200 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
